...
# python train.py -e $MODEL_NAME\_gdd_extra --source $SOURCE --target $TARGET --with_gdd_extra=True --with_pos_enc=False
# python train.py -e $MODEL_NAME\_gdd_sinusoid --source $SOURCE --target $TARGET --pos_type default --with_gdd_enc=True
python train.py -e $MODEL_NAME\_gdd_fourier --source $SOURCE --target $TARGET --pos_type fourier
# python train.py -e $MODEL_NAME\_gdd_rnn --source $SOURCE --target $TARGET --pos_type rnn
